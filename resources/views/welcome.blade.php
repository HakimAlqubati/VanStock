                ...
                <div class="timeline-track" id="timelineTrack">
                    ...
                    <div class="timeline-step {{ $index == 1 ? 'active' : '' }}" data-index="{{ $index }}">
                        <div class="timeline-icon-wrapper">
                            <div class="timeline-number" style="border-color: {{ $step['color'] }}; color: {{ $step['color'] }}; box-shadow: 0 0 20px {{ $step['color'] }}40">
                                {!! $step['icon'] !!}
                            </div>
                        </div>
                        <div class="timeline-content" style="border-top: 2px solid {{ $step['color'] }}">

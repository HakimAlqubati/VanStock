...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-M5FYQMEZWJ"></script>
    <script>
...
<body>
    ...
    <script src="{{ asset('js/landing/script.js') }}?v={{ time() }}"></script>
</body>

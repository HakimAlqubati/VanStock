<x-filament-panels::page>
    ...
    <div class="report-stats-grid-4">
        ...
        <div class="report-stat-card" style="background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%);">
            <div class="report-stat-card-inner">
                <div>
                    <p class="report-stat-label">{{ __('lang.stores_count') }}</p>
                    <p class="report-stat-value">{{ number_format($summary['stores_count']) }}</p>
                </div>
                <div class="report-icon-wrapper"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="report-icon">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64" />
                    </svg></div>
            </div>
        </div>
    </div>
    ...
    <div class="report-table-wrapper">
        ...
        <div class="report-table-scroll">
            <table class="report-table">
                ...
                <tfoot>
                    <tr>
                        <td colspan="2">{{ __('lang.total') }} ({{ $data->count() }})</td>
